...
<div class="header-content" id="historia">
    ...
    <h1>CaliSabi</h1>
    <h3 class="Nombre">Bienvenido Administrador <?php echo $use->getNom(); ?><h3>
...
<section class="general">
        ...
        try {
          ...
          foreach ($db->query($sql) as $row) { ?>
            <tr>
              ...
              <td>
                <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editarModal_<?php echo $row['IiOpinion'] ?>" href="">Editar</a>

                <!-- Modal -->
                <div class="modal fade" id="editarModal_<?php echo $row['IiOpinion'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form method="POST" action="includes/edit_comentario.php">
                          <div class="row form-group">
                            ...
                            <div class="col-sm-10">
                              <input type="hidden" id="id2" name="id2" value="<?php echo $row['IiOpinion']; ?>">
                              <input type="text" class="form-control" id="nombres" name="nombres" value="<?php echo $row['Comentario']; ?>">
                            </div>
                          </div>
                ...
                <div class="modal-body">
                <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?php echo $row['IiOpinion'] ?>" href="">Eliminar</a>
                <div class="modal fade" id="delete<?php echo $row['IiOpinion'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Eliminar comentario</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                        <form method="POST" action="includes/delete_comentario.php">
                          <div class="row form-group">
                            <div class="col-sm-2">
                              <label class="control-label" style="position: relative; top: 7px;">
                                <h6>Comentario</h6>
                            ...
                            <div class="col-sm-10">
                              <input type="hidden" id="id" name="id" value="<?php echo $row['IiOpinion']; ?>">
                              <input type="text" class="form-control" id="nombres" name="nombres" value="<?php echo $row['Comentario']; ?>">
                            </div>
                          </div>
                          <div class="modal-footer">
  ...
  <form action="./includes/add_comentario.php" method="POST">
    <div class="div1">
